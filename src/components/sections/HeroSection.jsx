    ...
    <section id="home" className="hero section">
      <div className="hero-copy">
        ...
        <div className="social-row" aria-label="Social profiles">
          <a className="linkedin-link" href="https://www.linkedin.com/in/haseeb-ullah-640531253/" target="_blank" rel="noreferrer" aria-label="LinkedIn" data-tooltip="LinkedIn">
          ...
          <a className="behance-link" href="https://www.behance.net/haseebullahgraphicx" target="_blank" rel="noreferrer" aria-label="Behance" data-tooltip="Behance">
            <svg viewBox="0 0 24 24" aria-hidden="true">
